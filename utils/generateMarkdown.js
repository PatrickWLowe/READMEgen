...
function renderLicenseLink(license) {
  ...
  if (license === "MIT") {
    ...
    return licenselink = "[IBM Public License Version 1.0](https://opensource.org/licenses/IPL-1.0"
  }
  else if (license === null) {
    return licenselink = ""
  }
...
function renderLicenseSection(license) {
  ...
  if (license === "MIT") {
    ...
    return sec = "This project is licensed under the IBM Public License Version 1.0 License"
  }
  else if (license === null) {
    return sec = ""
  }
